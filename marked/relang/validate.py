#!/usr/bin/env python3
"""
Local test runner: reads input/*.json, runs participant tool, hashes output,
compares against expected hashes from output/*.json.

Usage:  python validate.py <program_cmd>
...
INPUT_TYPE = CONFIG["input_type"]  # "stdin" or "file"
GREEN = "\033[92m"
RED = "\033[91m"
RESET = "\033[0m"
